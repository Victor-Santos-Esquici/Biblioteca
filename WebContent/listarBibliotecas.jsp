...
<html lang="pt-br">
	...
	<body>
	    ...
	    <div class="container contentMargin">
			<a class="btn btn-success" href="BibliotecaController?action=insert">Adicionar</a>
			<br><br>
	    		...
	    		<tbody>
	    			<c:forEach items="${bibliotecaList}" var="biblioteca">
		    			<tr>
		    				...
		    				<td width="50px">
		    					<a href="BibliotecaController?action=edit&codBib=<c:out value="${biblioteca.codBib}"/>" type="button" class="btn btn-sm btn-warning btnEdit btnSize">Editar</a>
		    					<a href="BibliotecaController?action=delete&codBib=<c:out value="${biblioteca.codBib}"/>" type="button" class="btn btn-sm btn-danger btnDelete btnSize">Deletar</a>
		    				</td>
		    			</tr>
	    			</c:forEach>
	    		</tbody>
